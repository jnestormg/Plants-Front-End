    ...
    return (
        <>
            ...
            <Select value={props.valor ? JSON.stringify(props.valor) : ""} onChange={actualizarValor}>
                ...
                {RequerimientoLuz.map((requerimientoLuz) => {
                    return (
                        <Option key={requerimientoLuz.id} value={JSON.stringify(requerimientoLuz)}>
                            {requerimientoLuz.requerimiento}
                        </Option>
                    );
                })}
            </Select>
...
export default RequerimientoLuz;
